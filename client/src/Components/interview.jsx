...
const Interview = () => {
  ...
  const fetchInterviews = async () => {
    try {
      const response = await fetch(
        "https://testings12345.azurewebsites.net/api/v1/interview"
      );
      if (!response.ok) {
  ...
  const handleDeleteInterview = async id => {
    try {
      const response = await fetch(
        `https://testings12345.azurewebsites.net/api/v1/interview/${id}`,
        {
          method: "DELETE",
        }
      );
  ...
  const handleDownload = async () => {
    try {
      ...
      const response = await fetch(
        "https://testings12345.azurewebsites.net/api/v1/interview/all/student"
      );
      if (!response.ok) {
