...
const BatchDetailsPage = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (editingBatch) {
      ...
      fetch(`http://localhost:4000/api/v1/batches/${editingBatch._id}`, {
        method: "PUT",
        headers: {
      ...
      fetch("http://localhost:4000/api/v1/batches/create", {
        method: "POST",
        headers: {
          "Content-Type": "application/json"
        },
  ...
  const handleDeleteBatch = async (id) => {
    try {
      const response = await fetch(`http://localhost:4000/api/v1/batches/${id}`, {
        method: "DELETE"
      });
      if (!response.ok) {
    ...
    <div>
      ...
      <div className="batch-details">
        ...
        <div className="button-container">
          <button className="add-batch-button" onClick={() => setShowPopup(true)}>Add Batch</button>
        </div>
        <table id="batchs">
          <thead>
            <tr>
            ...
            <div className="popup">
              <div className="popup-content">
                ...
                <form onSubmit={handleSubmit}>
                  ...
                  <button type="submit">{editingBatch ? "Save" : "Submit"}</button>
