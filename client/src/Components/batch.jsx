...
const BatchDetailsPage = () => {
  ...
  const handleSubmit = e => {
    ...
    if (editingBatch) {
      ...
      fetch(
        `https://testings12345.azurewebsites.net/api/v1/batches/${editingBatch._id}`,
        {
          method: "PUT",
          headers: {
      ...
      fetch("https://testings12345.azurewebsites.net/api/v1/batches/create", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
  ...
  const handleDeleteBatch = async id => {
    try {
      const response = await fetch(
        `https://testings12345.azurewebsites.net/api/v1/batches/${id}`,
        {
          method: "DELETE",
        }
      );
