...
const StudentDetailsPage = () => {
  ...
  const fetchStudents = async () => {
    try {
      const response = await fetch(
        "https://testings12345.azurewebsites.net/api/v1/student"
      );
      if (!response.ok) {
  ...
  const fetchBatches = async () => {
    try {
      const response = await fetch(
        "https://testings12345.azurewebsites.net/api/v1/batches"
      );
      if (!response.ok) {
  ...
  const handleSubmit = e => {
    ...
    if (editingStudent) {
      fetch(
        `https://testings12345.azurewebsites.net/api/v1/student/${editingStudent._id}`,
        {
          method: "PUT",
          headers: {
      ...
      fetch("https://testings12345.azurewebsites.net/api/v1/student", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
  ...
  const handleDeleteStudent = async id => {
    try {
      const response = await fetch(
        `https://testings12345.azurewebsites.net/api/v1/student/${id}`,
        {
          method: "DELETE",
        }
      );
